...
public class ESPMContainerMetadata {
    ...
    public class ActionImports {
        private static var generateSamplePurcharOrders_: DataMethod = ESPMContainerMetadataParser.parsed.dataMethod(withName: "GenerateSamplePurcharOrders")
        ...
        public static var generateSamplePurcharOrders: DataMethod {
            get {
                objc_sync_enter(ESPMContainerMetadata.ActionImports.self)
                defer { objc_sync_exit(ESPMContainerMetadata.ActionImports.self) }
                do {
                    return ESPMContainerMetadata.ActionImports.generateSamplePurcharOrders_
                }
            }
            set(value) {
                objc_sync_enter(ESPMContainerMetadata.ActionImports.self)
                defer { objc_sync_exit(ESPMContainerMetadata.ActionImports.self) }
                do {
                    ESPMContainerMetadata.ActionImports.generateSamplePurcharOrders_ = value
                }
            }
        }
