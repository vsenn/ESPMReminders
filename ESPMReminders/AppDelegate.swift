...
class AppDelegate: UIResponder, UIApplicationDelegate, UINavigationControllerDelegate, OnboardingManagerDelegate, ConnectivityObserver, UNUserNotificationCenterDelegate {
    ...
    func onboarded(onboardingContext: OnboardingContext, onboarding _: Bool) {
        var configurationURL = (onboardingContext.info[OnboardingInfoKey.sapcpmsSettingsParameters] as! SAPcpmsSettingsParameters).url(forDestination: "com.sap.tutorials.demoapp.ESPMReminders")
        ...
        if configurationURL == nil {
            ...
            configurationURL = URL(string: "https://hcpms-p1723681063trial.hanatrial.ondemand.com/com.sap.tutorials.demoapp.ESPMReminders")!
        }
